...
public class AGVWatcher : MonoBehaviour
{
    ...
    {
        //타겟의 방향을 알아야 내야 함.
        //목적지위치 - 현재 위치 => 현재 위치기준 목적의 방향과 거리를 구할 수 있다.
        ...
        //벡터의 내적을 이용해서 정명방향에 목적지가 있는지 값을 구할 수 있다.
